...
func (f *flag) Init(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(&f.Namespace, flagNamespace, "", fmt.Sprintf("Namespace where the app will be deployed"))
	cmd.Flags().StringVar(&f.TargetNamespace, flagTargetNamespace, "", "Namespace where the app will be deployed.")
	cmd.Flags().StringVar(&f.Cluster, flagCluster, "", fmt.Sprintf("Name of the cluster the app will be deployed to"))
