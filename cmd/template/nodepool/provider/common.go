...
func newcapiMachinePoolCR(config NodePoolCRsConfig, infrastructureRef capi.ContractVersionedObjectReference, bootstrapConfigRef capi.ContractVersionedObjectReference) *capi.MachinePool {
	mp := &capi.MachinePool{
