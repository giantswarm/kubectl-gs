...
import (
	...
	appmod "github.com/giantswarm/kubectl-gs/v6/internal/gitops/filesystem/modifier/app"
	...
	updatetmpl "github.com/giantswarm/kubectl-gs/v6/internal/gitops/structure/updates/templates"
)
