...
func (s *Service) getAllGCP(ctx context.Context, namespace string) (Resource, error) {
...
func (s *Service) getByNameGCP(ctx context.Context, name, namespace string) (Resource, error) {
	var cluster Cluster
